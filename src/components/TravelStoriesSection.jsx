const stories = [
  {
    ...
    img: 'https://images.unsplash.com/photo-1517927033932-b3d18e61fb3a?q=80&w=1920&auto=format&fit=crop',
    featured: true,
  },
  {
    title: 'Back Packing',
...
function Card({ item, compact }) {
  return (
    <article className="rounded-2xl overflow-hidden bg-white shadow-[0_10px_30px_rgba(0,0,0,.06)]">
